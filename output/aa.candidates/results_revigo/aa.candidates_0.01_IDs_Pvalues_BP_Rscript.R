...
pdf( file="c:\Users\ASUS\Desktop\NonModelGOToolkit\NonModelGOToolkit\output\aa.candidates\results_revigo\aa.candidates_0.01_IDs_Pvalues_BP_treemap.pdf", width=16, height=9 ) # width and height are in inches
