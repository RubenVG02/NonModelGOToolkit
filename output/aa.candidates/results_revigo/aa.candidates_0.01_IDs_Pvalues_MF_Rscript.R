...
pdf( file="/Users/rubenvg/Desktop/NonModelGOToolkit-1/output/aa.candidates/results_revigo/aa.candidates_0.01_IDs_Pvalues_MF_treemap.pdf", width=16, height=9 ) # width and height are in inches
